...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		Item courseBook = new Book("Book", "Chemistry1", "2", "www.url.com", false, new Date(), new Date(), admin, "Wiley", 0.00, "false", "false", "First");
...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		Item book1 = new Book("ItemDBProxyWorks", "Chemistry1", "2", "SteacieBasement", true, new Date(), new Date(), newUser, "Wiley", 0.00);
		Item book2 = new Book("ItemDBProxyWorks", "ItemSearchTest", "2", "SteacieBasement", true, new Date(), new Date(), newUser, "Wiley", 0.00);
		Item book3 = new Book("ItemDBProxyWorks", "TestSearch", "2", "SteacieBasement", true, new Date(), new Date(), newUser, "Wiley", 0.00);
